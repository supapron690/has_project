    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="text-image">
                ...
                <div class="centered"><span class="Fontt" style="color:blue;">
                        <h1>มาแบ่งประสบการณ์ด้านสุขภาพกันเถอะ</h1>
                    </span></div>
                <button class="btn-image Fontt" style="background-color:#28a428;padding-left: 20px;padding-right: 20px;">
                    <h1>แชร์ประสบการณ์</h1>
                </button>
            </div>
        </div>
        <div>
