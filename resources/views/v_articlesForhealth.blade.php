...
<div class="row">
        ...
        <div class="text-image" style="width:100%;height:50%;">
                ...
                <div class="centered-articleForHealth"><span class="Fontt" style="color:blue;"><h1>กรุณากรอกสิ่งที่ต้องการค้นหา</h1></span>
                <form action="#">
                        <input id="icon-forHelath" type="text" class="form-control form-control-lg" name="info"  placeholder="เช่น โรงพยาบาล โรคหัวใจ บทความเพื่อสุขภาพ เป็นต้น">
                </form>
                </div>
        </div>
</div>
...
<div class="row" style="margin-top:16px;margin-bottom:16px;">
    <div class="col-md-10">
            <h1 class="text-left Fontt mb-3" style="margin-left:16px;margin-top:16px; display: inline;">บทความเพื่อสุขภาพ ด้านการรักษา</h1>
    </div>
