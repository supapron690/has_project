...
<div class="row">
        ...
        transform: translate(-50%, -50%);"><h3>ขั้นตอนที่ 1 : เลือกหมวดหมู่ที่ต้องการแชร์ประสบการณ์</h3></span>
        <div class="row">
...
<form action="#">
    ...
    <p style="padding-left:40px;padding-top:10px;padding-bottom:10px;background-color:#00004d;color:white">ขั้นตอนที่ 2 : ใส่รายละเอียดของเรื่องที่ต้องการแชร์ประสบการณ์</p>
    <br>
    <div class="row">
    <div class="col-md-2">
    ...
    <div class="row">
            ...
            <input type="text-box" style="width:90%;height:200px;" class="form-control form-control-sm" name="info">
            </div>
    </div>
    <br>
    <div class="row">
