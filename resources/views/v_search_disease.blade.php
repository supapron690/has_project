...
<body>
    <div class="container-fluid">
                ...
                <div class="centered-articleForDisease"><span class="Fontt" style="color:#00004d; text-shadow: 2px 1px gray;"
                    ...
                    <form action="#">
                        <input id="icon-forHelath" type="text" class="form-control form-control-lg Fontt" name="info"
                            placeholder="เช่น โรงหัวใจ โรคภูมิแพ้ ปวดหัว เป็นต้น">
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top:16px;margin-bottom:16px;">
            <div class="col-md-10">
                <h1 class="text-left Fontt mb-3" style="margin-left:16px;margin-top:16px; display: inline;">โรค หรือ
                    อาการ ที่มีการค้นหามากที่สุด</h1>
            </div>
        </div>
        ...
        <div class="row" style="margin-top:16px;margin-bottom:16px;">
            <div class="col-md-10">
                <h1 class="text-left Fontt mb-3" style="margin-left:16px;margin-top:16px; display: inline;">ค้นหาด้วยหมวดหมู่ของโรค
                    หรือ อาการ</h1>
            </div>
        </div>
